...
"""
Author: James Littlefair
License: MIT License

Tested on: Python 3.12+

This script identifies amino acid differences, ambiguous codons, premature stops,
and insertions/deletions from a multiple sequence alignment relative to a reference strain.
